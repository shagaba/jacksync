...
public class JacksyncDiffEngineTest {
	private ObjectMapper mapper;

	private JacksyncDiffEngine jacksyncDiffEngine;
    ...
    public void beforeEach() {
    	...
    	jacksyncDiffEngine = new JacksyncDiffEngine(mapper);
    }

    @Test(expected=IllegalArgumentException.class)
	public void diffFailsObjectMapperIsNull() throws Exception {
		// operations simple diff
    	jacksyncDiffEngine = new JacksyncDiffEngine(null);
	}

    @Test(expected=IllegalArgumentException.class)
	public void diffFailsDiffProcessorIsNull() throws Exception {
		// operations simple diff
    	jacksyncDiffEngine = new JacksyncDiffEngine(mapper, null);
	}
	...
	public void diffFailsSourceIsNull() throws Exception {
    	...
    	jacksyncDiffEngine.diff(source, target);
	}
	...
	public void addTitle() throws Exception {
		...
		JacksyncData jacksyncData = jacksyncDiffEngine.diff(postV1, postV1_1);
